...
const productLandingCopy = {
  ...
  en: {
    ...
    heroEyebrow: 'AI VISUAL PRODUCTION',
    heroTitle: 'Turn brand visual production into a system that keeps growing.',
    heroDescription: 'Connect assets, prompts, models, and outputs on one canvas. Agent plans and executes; every decision stays traceable.',
