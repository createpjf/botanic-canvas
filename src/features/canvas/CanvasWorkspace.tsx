...
const workspaceMessages = {
  ...
  en: {
    ...
    edgeActions: 'Selected connection actions', systemEdge: 'System output connection', selectedEdge: 'Connection selected', systemEdgeHint: 'Keeps generation lineage. Cannot delete or reconnect.', reconnectHint: 'Drag an endpoint to reconnect', delete: 'Delete', closeEdgeActions: 'Close connection actions', emptyGuide: 'Empty canvas guide', emptyTitle: 'Start from a goal', emptyDetail: 'Drop in product, scene, or reference images — or add a generation node.', addAssets: 'Add assets', imageGeneration: 'Image generation', videoGeneration: 'Video generation', agentStart: 'Describe the goal', agentStartDetail: 'Agent first sorts product, scene, and delivery specs.', dismissNotice: 'Dismiss notice',
    ...
    imageAsset: 'Image asset', selectedResult: 'Selected result', candidate: (index: number) => `Candidate ${index}`, builtNodes: (count: number) => `${count} ${count === 1 ? 'node' : 'nodes'} built`, blankCanvasSummary: 'Blank canvas · Ready to start', refinedVersion: 'Refined version', generatedImage: 'Generated image', keyVisualVersion: 'Key visual version', dropToAdd: 'Drop to add to canvas', uploadLimits: uploadLimitsLabel('en'), addCanvasNode: 'Add canvas node', addFromImage: 'Add from this image', connectSelected: 'Connect selected node', addNodeTitle: 'Add node', closeAddNode: 'Close add-node menu', continueImage: 'Continue from this image', connectToGenerate: 'Connect assets and a prompt', batchVariations: 'Batch variations', batchDetail: 'One output per asset in the group', continueVideo: 'Continue from this frame or clip', videoReferenceDetail: 'Connect first/last frames or refs', assets: 'Assets', assetsDetail: 'Add product, scene, or style refs', localImages: 'Local images', uploadImages: 'Upload', uploadToCanvas: 'Upload images to the canvas', preview: (name: string) => `${name} preview`, downloadMedia: 'Download original', closePreview: 'Close preview',
  },
} as const
