...
const editorMessages = {
  'zh-CN': {
    ...
    taskStatuses: { uploading: '提交素材', submission_unknown: '等待确认', queued: '任务排队', running: '真实生成中', succeeded: '待挑选', failed: '任务失败', cancelled: '已取消' }, waitedSeconds: (seconds: number) => `已等待 ${seconds} 秒`, waitedMinutes: (minutes: number, seconds: number) => seconds ? `已等待 ${minutes} 分 ${seconds} 秒` : `已等待 ${minutes} 分`,
