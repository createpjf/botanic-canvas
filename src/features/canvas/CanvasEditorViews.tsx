...
const editorMessages = {
  ...
  en: {
    ...
    textPlaceholder: 'Write a description or copy requirements', expandAll: 'Show all', collapse: 'Collapse', fold: 'Fold', textFooter: 'Connect to a generation node as its description',
