...
function agentQuickActions(locale: ProductLocale): Array<{ intent: BotanicAgentIntent; label: string; instruction: string }> {
  return locale === 'en' ? [
    ...
    { intent: 'redo_from_root', label: 'Redo original recipe', instruction: 'Reuse the original refs, prompt, and settings.' },
  ] : [
...
export default function AgentWorkspace({
  ...
  const copy = useProductMessages({
    ...
    en: {
      ...
      welcome: 'What are we making?', welcomeTarget: (name: string) => `Refine “${name}”`, welcomeBody: 'Chat, write prompts, search the project, or describe an image.', welcomeTargetBody: 'Keep the current visual and recipe. Change only what you asked.',
