...
export type AgentPublicErrorCode = 'INVALID_REQUEST' | 'INVALID_IDEMPOTENCY_KEY' | 'AGENT_TURN_INTENT_CONFLICT' | 'AGENT_THREAD_CONTEXT_REQUIRED' | 'AGENT_TURN_PREPARATION_FAILED' | 'AGENT_TURN_CANCELLED' | 'AGENT_TURN_FAILED' | 'AGENT_TURN_RESULT_MISSING' | 'AGENT_TURN_NOT_REPLAYABLE' | 'AGENT_TURN_DEADLINE_EXCEEDED' | 'AGENT_TURN_RESUME_LIMIT_REACHED' | 'AGENT_TURN_DURABILITY_UNAVAILABLE' | 'AGENT_PROTOCOL_VERSION_UNSUPPORTED' | 'REQUEST_CANCELLED' | 'AGENT_PLAN_FAILED' | 'AGENT_CHAT_FAILED' | 'TOOL_LOOP_LIMIT_REACHED' | 'TOOL_NO_PROGRESS' | 'TOOL_CALL_LIMIT_REACHED' | 'AGENT_TOOL_OUTCOME_UNKNOWN' | 'AGENT_TOOL_DUPLICATE_DISPATCH' | 'AGENT_SKILL_BINDING_UNKNOWN' | 'AGENT_SKILL_BINDING_DEPENDENCY' | 'AGENT_SKILL_BINDING_LIMIT' | 'AGENT_SKILL_DEPENDENCY_CONFLICT' | 'AGENT_SKILL_DEPENDENCY_LIMIT' | 'AGENT_SKILL_CONTEXT_TOO_LARGE' | 'AGENT_SKILL_SNAPSHOT_MISMATCH' | 'PROVIDER_NOT_CONFIGURED' | 'PROVIDER_TIMEOUT' | 'PROVIDER_AUTH_FAILED' | 'PROVIDER_RATE_LIMITED' | 'PROVIDER_UNAVAILABLE' | 'PROVIDER_REJECTED' | 'INVALID_PROVIDER_RESPONSE' | 'AGENT_CONTEXT_OVERFLOW'
