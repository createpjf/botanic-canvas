...
const document = {
  nodes: [
    ...
    { id: 'generate-b', type: 'generate', position: { x: 300, y: 200 }, data: { kind: 'generate', label: '主图 B', status: 'idle', settings: { model: 'm', aspectRatio: '4:5', resolution: '2K' }, batchCount: 2 } },
