...
export const botanicHttpRoutePatterns = Object.freeze({
  ...
  projectAgentSkill: /^\/api\/projects\/([^/]+)\/agent-skills\/([^/]+)$/,
  projectAgentSkillPreflight: /^\/api\/projects\/([^/]+)\/agent-skills\/([^/]+)\/preflight$/,
  projectAgentSkillReview: /^\/api\/projects\/([^/]+)\/agent-skills\/([^/]+)\/review$/,
  projectAgentSkillVersion: /^\/api\/projects\/([^/]+)\/agent-skills\/([^/]+)\/versions\/([^/]+)$/,
