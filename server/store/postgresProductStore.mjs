...
import { assertProjectPermission, assertWorkspacePermission, projectPermissionDecision } from '../auth/authorization.mjs'
import { artifactIndexLimits, artifactsFromActionReceipt, artifactsFromAgentMessage, artifactsFromDocument, artifactsFromGenerationJob, generationArtifactRefreshReport, generationArtifactsFromJobReport } from '../agent/semantic/botanicArtifactIndex.mjs'
import { applyGenerationJobToAgentRun, mergeAgentRunForWrite } from '../agent/semantic/botanicAgentRun.mjs'
import { agentEntityLimits, agentStateFromDocument, applyAgentSessionReadReceipts, compareAndSetAgentSessionSettings, mergeAgentStateIntoDocument, shouldApplyAgentEntityWrite, shouldApplyAgentRunWrite, stripAgentMessagesFromDocument, validateAgentEntityWriteTimestamp, validateAgentMemoryEntity, validateAgentMessageEntity, validateAgentSessionEntity, validateAgentSessionReadReceipt } from '../agent/semantic/botanicAgentPersistence.mjs'
import { agentMessageListOptions, encodeAgentMessageCursor, normalizeAgentSessionListLimit } from '../agent/thread/agentMessagePersistence.mjs'
...
import { mergeAgentMessageForWrite } from '../agent/thread/agentMessageMerge.mjs'
...
import { agentBranchRetryClaimDecision, agentBranchRetryJobDecision } from '../agent/run/agentBranchRetryClaim.mjs'
...
export async function createPostgresProductStore({ databaseUrl, bootstrapAccessToken, bootstrapEmail = 'owner@botanic.local' }) {
  ...
  await ensureBootstrapAccessToken(sql, { bootstrapAccessToken, bootstrapEmail, hashAccessToken, now })
